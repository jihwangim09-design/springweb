...
// [1] 전통 방식의 객체 생성 , 계속적인 dao인스턴스 생성 가능
...
// [2] 전통 방식의 싱글톤 생성 , 계속적인 dao인스턴스 생성 불가능
class SampleDao2{
    private SampleDao2(){}
...
class SampleController3{
    @Autowired // 1.스프링 컨테이너(메모리/저장소)에 등록된 빈(객체) 가져와서 대입
