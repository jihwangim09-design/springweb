...
@Controller // [서블릿 대신 ] HTTP 통신 지원하는 서블릿 제공 + @Component  @Component가 @Controller안에있음
public class RestController1 {
    // 1. http://localhost:8080/day03/task1     8080까지가 도메인임
    ...
    @ResponseBody
    public String task2(){
        System.out.println("RestController1.task2()"); // soutm+엔터: 현재메소드명'
...
/*
    @ResponsBody 란? 자바의 타입 --> HTTP content-type 변환하여 동일하게 사용/직렬화
    - String : text/plain;
    - 그외 : application/json
*/